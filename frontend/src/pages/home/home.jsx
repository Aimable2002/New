...
import { MdCallMissed, MdOutlineSignalWifiStatusbarConnectedNoInternet4 } from "react-icons/md";
...
//     }
//   };
// }, [socket, setMessages, selectedUser?._id]);

// useEffect(() => {
//   //Reset count when messages change
    ...
    : (
      ...
      <>
       ...
       <div className='header' style={{zIndex: '1'}}>
         ...
         <div style={{position: 'relative', marginTop: '4vh', fontSize: '20px'}}>ChatApp</div>
       </div>
       ...
       <div className='story-area'>
        <div className='story-flow'>
          ...
          <div className='story-owner'>{user.userName}</div>
            </div>
          ))}
      ...
      <div className='footer-icon' style={{zIndex: '2'}}>
        ...
        <Link to='/chat'><div><ForumRoundedIcon /></div></Link>
